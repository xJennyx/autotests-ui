...
class CreateCoursePage(BasePage):
    def __init__(self, page: Page):
        ...
        self.exercisers_title = page.get_by_test_id('create-course-exercises-box-toolbar-title-text')
        self.create_exercise_button = page.get_by_test_id('create-course-exercises-box-toolbar-create-exercise-button')

        self.exercisers_empty_view_icon = page.get_by_test_id('create-course-exercises-empty-view-icon')
        self.exercisers_empty_view_title = page.get_by_test_id('create-course-exercises-empty-view-title-text')
        self.exercisers_empty_view_description = page.get_by_test_id(
    ...
    def check_visible_exercises_title(self):
        expect(self.exercisers_title).to_be_visible()
        expect(self.exercisers_title).to_have_text('Exercises')
    ...
    def check_visible_exercises_empty_view(self):
        expect(self.exercisers_empty_view_icon).to_be_visible()

        expect(self.exercisers_empty_view_title).to_be_visible()
        expect(self.exercisers_empty_view_title).to_have_text('There is no exercises')

        expect(self.exercisers_empty_view_description).to_be_visible()
        expect(self.exercisers_empty_view_description).to_have_text(
